        ...
        <div class="row">
          <div class="col-md-12">
            <div class="page-heading">
              <h1>fresh salad for a hot summer</h1>
              <ul>
                <li><a href="<?php echo base_url(); ?>">Home</a></li>
                <li><a href=<?php echo site_url(router/open_url/portfolio); ?>">Menu</a></li>
                <li><span>fresh salad for a hot summer		</span></li>
              </ul>
            </div>
          </div>
        </div>
