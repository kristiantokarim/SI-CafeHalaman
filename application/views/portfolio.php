      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <?php site_url('menucontroller/fetchAllMenu'); echo "<h1>from view</h1>"; ?>
          </div>
          <div class="posts portfolio">
            ...
            <article class="col-md-4 col-xs-6 meat salads"><a href="portfolio-single.html"><img src="<?php echo base_url(); ?>assets/images/recent-post-2.jpg"/>
                <div class="hover"><i class="fa fa-cutlery"></i>
                  <h2>fresh salad for a hot summer</h2>
                </div></a></article>
            <article class="col-md-4 col-xs-6 meat"><a href="portfolio-single.html"><img src="<?php echo base_url(); ?>assets/images/recent-post-3.jpg"/>
                <div class="hover"><i class="fa fa-cutlery"></i>
                  <h2>fresh salad for a hot summer</h2>
                </div></a></article>
            <article class="col-md-4 col-xs-6 desserts salads"><a href="portfolio-single.html"><img src="<?php echo base_url(); ?>assets/images/recent-post-4.jpg"/>
                <div class="hover"><i class="fa fa-cutlery"></i>
                  <h2>fresh salad for a hot summer</h2>
                </div></a></article>
            <article class="col-md-4 col-xs-6"><a href="portfolio-single.html"><img src="<?php echo base_url(); ?>assets/images/recent-post-5.jpg"/>
                <div class="hover"><i class="fa fa-cutlery"></i>
                  <h2>fresh salad for a hot summer</h2>
                </div></a></article>
            <article class="col-md-4 col-xs-6 salads pasta"><a href="portfolio-single.html"><img src="<?php echo base_url(); ?>assets/images/recent-post-6.jpg"/>
                <div class="hover"><i class="fa fa-cutlery"></i>
                  <h2>fresh salad for a hot summer</h2>
                </div></a></article>
            <article class="col-md-4 col-xs-6 meat pasta"><a href="portfolio-single.html"><img src="<?php echo base_url(); ?>assets/images/recent-post-1.jpg"/>
                <div class="hover"><i class="fa fa-cutlery"></i>
                  <h2>fresh salad for a hot summer</h2>
                </div></a></article>
            <article class="col-md-4 col-xs-6 meat desserts"><a href="portfolio-single.html"><img src="<?php echo base_url(); ?>assets/images/recent-post-2.jpg"/>
                <div class="hover"><i class="fa fa-cutlery"></i>
                  <h2>fresh salad for a hot summer</h2>
                </div></a></article>
            <article class="col-md-4 col-xs-6 meat desserts pasta"><a href="portfolio-single.html"><img src="<?php echo base_url(); ?>assets/images/recent-post-3.jpg"/>
                <div class="hover"><i class="fa fa-cutlery"></i>
                  <h2>fresh salad for a hot summer</h2>
                </div></a></article>
          </div>
